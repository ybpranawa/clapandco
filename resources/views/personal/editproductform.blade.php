            ...
            <form role="form" class="form-horizontal" action="doedit" method="post" enctype="multipart/form-data">
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="product_name" name="product_name" placeholder="Nama Produk...." value="{{$query->product_name}}" required>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <textarea class="form-control" name="product_desc" placeholder="Deskripsi Produk...." required>{{$query->product_desc}}</textarea>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="product_stock" name="product_stock" placeholder="stok" value="{{$query->product_stock}}" required>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                      <input type="text" class="col-sm-1" id="product_timedev" name="product_timedev" value="{{$query->product_timedev}}" placeholder="0.." required>{{'Hari'}}
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                      <input type="text" class="form-control" id="product_price" name="product_price" value="{{$query->product_price}}" placeholder="0000...." required>
                  </div>
                </div>
